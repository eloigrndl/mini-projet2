...
public class Dialog implements Graphics {
    ...
    public Dialog(String text, String backgroundName, Area area) {
        ...
        final float fontSize = 0.045f * area.getCameraScaleFactor();
        ...
        sprite = new ImageGraphics(ResourcePath.getSprite(backgroundName), width, height, null, Vector.ZERO, 1.0f, 1000);
